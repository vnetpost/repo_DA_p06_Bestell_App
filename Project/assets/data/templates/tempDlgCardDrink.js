...
export function renderTmpDlgCardDrink(id) { // id -> 102, 502, ...
    let targetInst;
    ...
    ref_idDlgCardContainer.innerHTML = `
            <dialog id="idDlgCard" class="cDlgCard">
                ...
                <section class="cSecDlgVisiblePart cSecDlgVisiblePartJustDrinkCard">
    ...
    function renderDrinkOptions() {
        let htmlText = "";
        const elId = `idInputDrink${targetInst.id}`;
